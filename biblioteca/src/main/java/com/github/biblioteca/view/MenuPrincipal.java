...
public class MenuPrincipal implements Menu {
    ...
    private static EmprestimoView emprestimoView = new EmprestimoView(); // NOVO
    ...
    public void exibirMenu() {
        ...
        while (true) {
            System.out.println("\n------ MENU PRINCIPAL ------");
            System.out.println("1. Gerenciamento de Usuarios");
            System.out.println("2. Gerenciamento de Livros");
            System.out.println("3. Gerenciamento de Emprestimos"); // NOVO
            ...
            switch (op) {
                ...
                case 3 -> emprestimoView.exibirMenu(); // NOVO
                case 0 -> {
